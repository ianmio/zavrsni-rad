    ...
    <Container className="mb-[120px] md:mb-[133px] min-h-[562px] grid md:grid-cols-2 gap-8 md:gap-6 items-center justify-between md:pl-12 md:pr-12">
      <div className="md:max-w-[520px] w-full">
        ...
        <p className="text-base md:text-[20px] md:leading-[32px] tracking-[-0.02em] font-light">
          From wandering ancient Diocletian’s Palace to soaking up sunsets on
          the Riva, our time in Split was packed with unforgettable moments.
          Laughter echoed through cobblestone streets, spontaneous swims turned
          into lasting memories, and every corner brought a new story. Split
          wasn’t just a destination – it was an adventure we lived together.
        </p>
      </div>
