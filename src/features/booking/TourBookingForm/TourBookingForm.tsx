  ...
  return (
    <div className="w-full bg-white-100 p-4 md:p-8 h-fit lg:max-w-[392px]">
      ...
      <div className="text-base tracking-[-0.02em] text-[#454553] flex items-center gap-2 mb-6 md:mb-8">
        <p className="opacity-50 uppercase">{t('available-slots')}</p>
      ...
      <div className="mb-6 md:mb-8 flex items-center justify-between">
        <p className="text-base text-[#454553] font-semibold">{t('people')}</p>
      ...
      <div className="mb-6 md:mb-8">
        ...
        <p className="text-base text-[#A2A2A9] font-semibold">
          {t('people')}: <span className="text-[#454553]">{guestCount}</span>
        </p>
        <p className="text-base text-[#A2A2A9] font-semibold">
          {t('date')}:{' '}
      ...
      >
        {isSubmitting ? <Spinner className="text-white-100" /> : t('checkout')}
      </button>
    </div>
  );
};
